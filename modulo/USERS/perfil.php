...
<div class="container text-center">
  <div class="perfil-card mx-auto col-md-6 mt-5">
    ...
    <p class="text-info"><?= ucfirst($usuario['tipo_usuario']) ?></p>
    <hr>
    ...
    <p><strong>Personaje:</strong> <?= htmlspecialchars($usuario['personaje']) ?></p>
    <hr>
    <a href="cambiar_personaje.php" class="btn btn-primary">Cambiar Personaje</a>
